  ...
  (let [top-wall (->> (cube (+ keyswitch-width 3) 1.5 plate-thickness)
        ...
        left-wall (->> (cube 2 (+ keyswitch-height 3) plate-thickness)
                       (translate [(+ (/ 1.5 2) (/ keyswitch-width 2))
                                   0
                                   (/ plate-thickness 2)]))
        kailh-cutout (->> (cube (/ keyswitch-width 3) 1.5 plate-thickness)
                          (translate [0
                                  (+ (/ 1.5 2) (+ (/ keyswitch-height 2) 0.2))
                                  (/ plate-thickness)]))
        side-nub (->> (binding [*fn* 30] (cylinder 1 2.75))
                      (rotate (/ π 2) [1 0 0])
                      (translate [(+ (/ keyswitch-width 2)) 0 1])
                      (hull (->> (cube 1.6 2.75 plate-thickness)
                                 (translate [(+ (/ 1.6 2) (/ keyswitch-width 2))
                                             0
                                             (/ plate-thickness 2)]))))
